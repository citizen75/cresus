...
class FlowManager:
	...
	def run_workflow(self, workflow_name: str, strategy: str = "default", input_data: Optional[Dict[str, Any]] = None, include_context: bool = False, debug: bool = False) -> Dict[str, Any]:
		"""Run a workflow.
